...
/**
 * AES-256-GCM encryption for sensitive fields (datasource passwords, API secrets).
 * Key must be provided via environment variable ETL_ENCRYPTION_KEY (32 bytes base64).
 */
